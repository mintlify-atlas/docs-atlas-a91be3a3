---
title: "Working with Docker Containers in Bollard – Async API"
sidebarTitle: "Containers"
description: "Create, start, stop, inspect, attach, and stream logs for Docker containers using Bollard's fully async Rust container lifecycle API."
---
