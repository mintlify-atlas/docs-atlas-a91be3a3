---
title: "Bollard Networks API: Create, Connect, and Prune Networks"
sidebarTitle: "Networks"
description: "Reference for Bollard network methods: list, create, inspect, connect, disconnect, remove, and prune Docker networks with full parameter details."
---
