...
description: "The Docker struct is the entry point for all Bollard API calls. Reference for connect_with_* constructors, timeout settings, and custom transports."
---
