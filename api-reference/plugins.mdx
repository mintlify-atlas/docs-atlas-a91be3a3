---
title: "Docker Plugins API Reference — Bollard Rust Client"
sidebarTitle: "Plugins"
description: "Reference for Bollard plugin methods: list, inspect, install, enable, disable, upgrade, push, create, set config, and remove Docker plugins."
---
