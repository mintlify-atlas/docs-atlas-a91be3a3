---
title: "Nodes API Reference for Bollard"
sidebarTitle: "Nodes"
description: "Reference for Bollard node methods: list, inspect, update, and delete nodes in a Docker Swarm cluster."
---
...
| Builder method | Type | Description |
|---|---|---|
| `.version(u64)` | `u64` | **Required.** Current version index from `inspect_node`. |
