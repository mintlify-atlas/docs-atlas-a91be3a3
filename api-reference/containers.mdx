---
title: "Containers API Reference for Bollard"
sidebarTitle: "Containers"
description: "Complete reference for all Bollard container methods: list, create, start, stop, inspect, attach, stats, exec, and more with parameter details."
---
