---
title: "Bollard Exec API: Run Commands in Running Containers"
sidebarTitle: "Exec"
description: "Reference for Bollard exec methods: create_exec, start_exec, inspect_exec, and resize_exec for running commands inside running containers."
---
