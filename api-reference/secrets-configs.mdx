---
title: "Secrets and Configs API Reference for Bollard"
sidebarTitle: "Secrets & Configs"
description: "Reference for Bollard secret and config methods: list, create, inspect, delete, and update Docker Swarm secrets and configs."
---
