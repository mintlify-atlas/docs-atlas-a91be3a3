---
title: "Connect Bollard to Remote Docker via SSH Tunnel"
sidebarTitle: "SSH Tunnel"
description: "Use Bollard's SSH connector to tunnel Docker API calls over an SSH connection using openssh. Requires the ssh feature flag."
---
